...
function BlogCard({ blog, handleDeleteBlog }) {
  ...
  return (
    // <article className="relative flex md:flex-row flex-col md:items-center bg-white/10 shadow mx-auto px-4 rounded-2xl max-w-md md:max-w-5xl">
    //   {user ? (
    //     user.id === blog.userId ? (
    //       <div className="right-5 bottom-5 absolute flex gap-2.5">
    //         <button className="bg-slate-300 hover:bg-white p-2 rounded-full transition-colors duration-300 cursor-pointer">
    //           <svg
    //             width="20px"
    //             height="20px"
    //             viewBox="0 0 24 24"
    ...
    //   <div className="my-4 md:mr-8 md:max-w-xs shrink-0">
    //     <img
    ...
    //     <p className="block mb-6 font-medium text-gray-300 text-2xl line-clamp-1">
    //       {blog.title}
    //     </p>
